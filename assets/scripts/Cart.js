...
//             <div class="container__cart-Item-quantity">
...
//               }', 'increase')">+</button>
//             </div>
//             <span class="container__cart-Item-price">${itemTotal.toLocaleString(
//               "vi",
//               { style: "currency", currency: "VND" }
//             )}</span>
//           </div>
//           <div class="container__cart-Item-body">
//             <div class="container__cart-Item-desciption">Phân Loại: ${
//               item.type
//             }</div>
//             <span class="container__cart-Item-remove" onclick="deleteCart('${
//               item.name
//             }')">Xóa</span>
//           </div>
//         </div>
...
//         <strong>Tổng tiền: ${totalPaymentMoney.toLocaleString("vi", {
//           style: "currency",
//           currency: "VND",
//         })}</strong>
//       </div>
...
//   document.querySelector(".cartPayment").innerHTML = `
//     <div class="btn-cart">
//       <button id="openDeliveryModalBtn" class="btn-Product">Tiến hành Thanh toán</button>
//     </div>
//   `;
//   setupCartPaymentEvents();
// }
...
function sendRequire(arr) {
  if (arr.length == 0) return false;
    ...
    toast({
      ...
      title: "Đơn hàng",
      message:
        "Đã gửi yêu cầu đơn hàng cho người bán\nVui lòng đợi phản hồi từ người bán !",
      duration: 3000,
    });
  }
}
