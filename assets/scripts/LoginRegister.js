...
function login() {
  ...
  btnLogin.addEventListener("click", () => {
    ...
    // Lưu user vào localStorage mà không kiểm tra gì cả
    localStorage.setItem("currentUser", username.value || "guest");

    // Cập nhật UI
    var handler = document.querySelector(".js-HandlerLR");
    handler.classList.remove("is-relatived");
    ...
    `;
    handler.parentElement.insertBefore(
      logoutBtn,
      document.querySelector(".line")
    );

    // Thêm class và xóa form
    handler.classList.add("js-isLogin");
...
function loadUserProfileData() {
  ...
  document.getElementById("profile-display-username").textContent =
    currentUser.username || "N/A";
  document.getElementById("profile-display-username2").textContent =
    currentUser.username || "N/A";
  document.getElementById("profile-display-fullname").textContent =
    currentUser.fullname || "Chưa cập nhật";
  document.getElementById("profile-display-email").textContent =
    currentUser.gmail || "N/A";
  document.getElementById("profile-display-email2").textContent =
    currentUser.gmail || "N/A";
  document.getElementById("profile-display-phone").textContent =
    currentUser.phone || "Chưa cập nhật";
  document.getElementById("profile-display-address").textContent =
    currentUser.address || "Chưa cập nhật";
  document.getElementById("profile-display-registerday").textContent =
    currentUser.RegisterDay || "N/A";
  ...
  document.getElementById("profile-edit-fullname").value =
    currentUser.fullname || "";
  document.getElementById("profile-edit-phone").value = currentUser.phone || "";
  document.getElementById("profile-edit-address").value =
    currentUser.address || "";
